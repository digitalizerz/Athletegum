                ...
                <div class="card-body p-0">
                    <div class="divide-y divide-base-300">
                        @foreach($deals as $deal)
                            ...
                            @endphp
                            <a href="{{ route('athlete.deals.messages', $deal) }}" class="block p-4 hover:bg-base-200 transition">
        ...
        @else
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body text-center py-12">
                    ...
                    <p class="text-sm text-base-content/50">Start a conversation by accepting a deal.</p>
                </div>
            </div>
        @endif
    </div>
