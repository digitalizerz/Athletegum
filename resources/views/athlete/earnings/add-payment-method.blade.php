            ...
            <div class="max-w-2xl space-y-6">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-6">
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-4">Click the button below to connect your Stripe account</p>
                        <button type="button" class="inline-flex items-center px-6 py-3 bg-indigo-600 border border-transparent rounded-md font-semibold text-sm text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition">
                ...
                <!-- Note: In production, this would redirect to Stripe Connect OAuth -->
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <p class="text-sm text-yellow-800">
                        <strong>Note:</strong> Stripe Connect integration is currently in development. For now, you can manually add your Stripe account ID below for testing purposes.
                    </p>
                </div>

                <!-- Manual Stripe Account ID (for testing) -->
                <div>
                    <label for="provider_account_id" class="block text-sm font-medium text-gray-700 mb-2">Stripe Account ID (Optional - for testing)</label>
                    <x-text-input
                    ...
                    />
                    <p class="mt-2 text-xs text-gray-500">Leave blank if connecting via Stripe Connect button above</p>
