<header class="bg-base-100 border-b border-base-300 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex items-center space-x-3">
        ...
        <div class="dropdown dropdown-end">
            <label tabindex="0" class="btn btn-ghost relative hover:bg-base-200 focus:bg-base-200" style="width: 40px; height: 40px; padding: 0; display: flex; align-items: center; justify-content: center; border-radius: 50%;">
                <svg class="flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" style="width: 22px; height: 22px; color: #1f2937 !important; stroke: #1f2937 !important;">
